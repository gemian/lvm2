...
#define DEFAULT_LOCK_DIR "/tmp/lvm/lock"
...
#define DEFAULT_RUN_DIR "/tmp/lvm/run"
...
#define DEFAULT_SYS_DIR "/tmp/etc"
...
/* Library version */
#define DM_LIB_VERSION "1.02.179-git (2021-05-07)"
...
#define LVMCONFIG_PATH "/sbin/lvmconfig"
...
#define LVM_CONFIGURE_LINE "./configure --prefix=/tmp/lvm --enable-static_link --disable-readline --disable-selinux --with-confdir=/etc --with-default-run-dir=/tmp/lvm/run --with-default-system-dir=/tmp/etc --with-default-locking-dir=/tmp/lvm/lock --with-vdo=none"
...
#define TESTSUITE_DATA "/tmp/lvm/share/lvm2-testsuite"

/* The path to 'thin_check', if available. */
#define THIN_CHECK_CMD "/sbin/thin_check"
...
#define VDO_FORMAT_CMD "autodetect"
